...
AppId={{81F4E42A-A3FC-4972-B4D2-C12B6DDA61B2}
AppName={#MyAppName}
...
OutputBaseFilename={#MyAppName} Portuguese installer
...
[Files]
Source: "..\LANGS\pt\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\pt\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
