...
AppId={{531A9DED-BB49-4890-AA6F-6563B22E8AEA}
AppName={#MyAppName}
...
OutputBaseFilename={#MyAppName} French installer
...
[Files]
Source: "..\LANGS\fr\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\fr\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
