...
OutputBaseFilename={#MyAppName} English installer
...
[Files]
Source: "..\LANGS\en\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\en\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
