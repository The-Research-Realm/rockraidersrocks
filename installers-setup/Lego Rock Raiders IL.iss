...
OutputBaseFilename={#MyAppName} Hebrew installer
...
[Files]
Source: "..\LANGS\il\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\il\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
