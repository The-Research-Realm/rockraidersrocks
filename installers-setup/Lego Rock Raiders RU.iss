...
AppId={{D5BC4438-230E-41F0-99AC-886EE10AE690}
AppName={#MyAppName}
...
OutputBaseFilename={#MyAppName} Russian installer
...
[Files]
Source: "..\LANGS\ru\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\ru\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
