...
OutputBaseFilename={#MyAppName} Philippine installer
...
[Files]
Source: "..\LANGS\ph\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\ph\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
