...
OutputBaseFilename={#MyAppName} Czech installer
...
[Files]
Source: "..\LANGS\cz\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\cz\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
