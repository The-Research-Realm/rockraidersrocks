...
AppId={{10020166-3ACD-49A8-A3BB-483040012006}
AppName={#MyAppName}
...
OutputBaseFilename={#MyAppName} Swedish installer
...
[Files]
Source: "..\LANGS\se\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\se\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
