...
AppId={{984775DA-0539-46BE-AACD-20161B2BF320}
AppName={#MyAppName}
...
OutputBaseFilename={#MyAppName} Polish installer
...
[Files]
Source: "..\LANGS\pl\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\pl\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
