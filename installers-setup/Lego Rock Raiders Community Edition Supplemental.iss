...
#define MyAppName "Lego Rock Raiders Community Edition Supplemental"
#define MyAppPublisher "Research Realm"
#define MyAppURL "https://researchrealm.net/"
#define MyAppExeName "Cafeteria.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{853CF13A-F6CC-4454-9FF2-1D1C0B30C617}
AppName={#MyAppName}
...
DefaultDirName={autopf}\Lego Rock Raiders
DisableDirPage=yes
...
[Files]
Source: "..\ALTERATIONS\{#MyAppName}\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\ALTERATIONS\{#MyAppName}\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Root: HKCU; Subkey: "Software\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers"; ValueType: string; ValueName: "C:\Program Files (x86)\Lego Rock Raiders\LegoRRCE.exe"; ValueData: "~ 16BITCOLOR WINXPSP3 DWM8And16BitMitigation"; Flags: uninsdeletevalue
...
; This part is added because when Cafetaria is used, it would create all these extra files which we should cleanup if the user uninstalls the game. E.g. they borked their wadd files so hard, they reinstall the game and we should start fresh.
[UninstallDelete]
Type: filesandordirs; Name: "{app}\DataSource"
Type: filesandordirs; Name: "{app}\Cafeteria"
Type: filesandordirs; Name: "{app}\Data\Buildings"
Type: filesandordirs; Name: "{app}\Data\Creatures"
Type: filesandordirs; Name: "{app}\Data\Information"
Type: filesandordirs; Name: "{app}\Data\Interface"
Type: filesandordirs; Name: "{app}\Data\Languages"
Type: filesandordirs; Name: "{app}\Data\Levels"
Type: filesandordirs; Name: "{app}\Data\Mini-Figures"
Type: filesandordirs; Name: "{app}\Data\MiscAnims"
Type: filesandordirs; Name: "{app}\Data\Sounds"
Type: filesandordirs; Name: "{app}\Data\Vehicles"
Type: filesandordirs; Name: "{app}\Data\World"
Type: filesandordirs; Name: "{app}\Data\Credits.txt.cconv"
Type: filesandordirs; Name: "{app}\Data\Lego.cfg"
Type: filesandordirs; Name: "{app}\Data\LoaderProfile.txt"
Type: filesandordirs; Name: "{app}\Data\LoaderProfileNoSound.txt"