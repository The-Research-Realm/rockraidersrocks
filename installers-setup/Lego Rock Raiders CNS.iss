...
AppId={{02CBADF5-0F41-40A8-9931-39311350E3F4}
AppName={#MyAppName}
...
OutputBaseFilename={#MyAppName} Chinese Simplified installer
...
[Files]
Source: "..\LANGS\CNS\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\CNS\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
