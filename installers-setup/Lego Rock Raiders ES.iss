...
AppId={{43D63C1C-79F6-4DF4-AE9C-027EAC55E8A5}
AppName={#MyAppName}
...
OutputBaseFilename={#MyAppName} Spanish installer
...
[Files]
Source: "..\LANGS\es\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\es\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
