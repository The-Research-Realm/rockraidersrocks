...
AppId={{1CE461EB-F022-4487-BB46-AEAEB64CACD7}
AppName={#MyAppName}
...
OutputBaseFilename={#MyAppName} Italian installer
...
[Files]
Source: "..\LANGS\it\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\it\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
