...
#define MyAppName "Lego Rock Raiders OpenLRR Supplemental"
#define MyAppPublisher "Research Realm"
#define MyAppURL "https://researchrealm.net/"
#define MyAppExeName "OpenLRR.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{BCCBC740-699E-48A7-A21C-3CF3FB55D7A1}
AppName={#MyAppName}
...
[Files]
Source: "..\ALTERATIONS\{#MyAppName}\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
...
Root: HKCU; Subkey: "Software\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers"; ValueType: string; ValueName: "C:\Program Files (x86)\Lego Rock Raiders\{#MyAppExeName}"; ValueData: "~ WINXPSP3"; Flags: uninsdeletevalue
