...
AppId={{140215E4-9539-4E5E-A821-54CAE47C387B}
AppName={#MyAppName}
...
OutputBaseFilename={#MyAppName} Danish installer
...
[Files]
Source: "..\LANGS\dk\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\dk\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
