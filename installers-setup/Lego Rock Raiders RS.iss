...
AppId={{DB37DD53-B38B-417D-800C-AC6C2EED6AB2}
AppName={#MyAppName}
...
OutputBaseFilename={#MyAppName} Serbian installer
...
[Files]
Source: "..\LANGS\rs\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\rs\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
