...
AppId={{C8604B22-4E70-4039-88A2-DCCB457535CE}
AppName={#MyAppName}
...
OutputBaseFilename={#MyAppName} Croatian installer
...
[Files]
Source: "..\LANGS\hr\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\hr\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
