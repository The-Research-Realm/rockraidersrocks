...
AppId={{C4CBE391-6DCA-461A-B73A-A7A1D17957B4}
AppName={#MyAppName}
...
OutputBaseFilename={#MyAppName} Japanese installer
...
[Files]
Source: "..\LANGS\jp\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\jp\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
