...
AppId={{24B737AD-7DBD-40E1-9E7F-B0349EA78DD7}
AppName={#MyAppName}
...
OutputBaseFilename={#MyAppName} German installer
...
[Files]
Source: "..\LANGS\de\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\de\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
