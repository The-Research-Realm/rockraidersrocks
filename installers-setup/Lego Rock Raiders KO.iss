...
AppId={{DFBDAB1F-411E-41DB-B25D-5F83DB452801}
AppName={#MyAppName}
...
OutputBaseFilename={#MyAppName} Korean installer
...
[Files]
Source: "..\LANGS\ko\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\LANGS\ko\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
